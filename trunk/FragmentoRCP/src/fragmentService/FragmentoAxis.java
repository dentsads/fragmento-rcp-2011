...
public class FragmentoAxis {
	...
	// FragmentServiceStub.Lock_type0[] locks = new
	// FragmentServiceStub.Lock_type0[1];
	// releaseLocks(locks);
	// createRelation("bla bla", 201, 210, RelationTypeSchemaType.modeller);
	// deleteRelation(226);
	// //updateRelation(225, "bla bla 2", 164, 210,
	// RelationTypeSchemaType.annotation);
	// } catch (Exception e) {
	// e.printStackTrace();
	// System.err.println("\n\n\n");
	// }
	 ...
	 */
	public FragmentServiceStub.CreateArtefactResponseMessage createArtifact(
	 ...
	 *         caught
	 */
	public FragmentServiceStub.RetrieveArtefactResponseMessage retrieveArtifact(
			long artifactId) {
		try {
	 ...
	 * @return
	 */
	public FragmentServiceStub.RetrieveArtefactBundleResponseMessage retrieveArtifactBundle(
			long artifactId) {
		try {
	 ...
	 * @return
	 */
	public FragmentServiceStub.RetrieveArtefactHistoryResponseMessage retrieveArtifactHistory(
			long artifactId) {
		try {
	 ...
	 * @return
	 */
	public FragmentServiceStub.CheckOutArtefactResponseMessage checkoutArtifact(
			long artifactId) {
		try {
	 ...
	 * @return
	 */
	public FragmentServiceStub.CheckInArtefactResponseMessage checkinArtifact(
		...
		try {
			...
			req.setArtefact(type);
			req.setLockId(browseLocks().getLockDescriptors().getLock()[0]
					.getLockId());
	 ...
	 */
	public FragmentServiceStub.BrowseArtefactsResponseMessage browseArtifact_byType(
			String artifactType) {
		try {
	 ...
	 * @return
	 */
	public FragmentServiceStub.BrowseArtefactsResponseMessage browseArtifact_byDate(
	 ...
	 * @return
	 */
	public FragmentServiceStub.BrowseArtefactsResponseMessage browseArtifact_byContent(
			String content) {
		try {
			FragmentServiceStub.BrowseArtefactsRequestMessage req = new FragmentServiceStub.BrowseArtefactsRequestMessage();
			FragmentServiceStub.BrowseArtefactSelectorType type = new FragmentServiceStub.BrowseArtefactSelectorType();
	 ...
	 * @return
	 */
	public FragmentServiceStub.BrowseArtefactsResponseMessage browseArtifact_byDescription(
			String description) {
		try {
			FragmentServiceStub.BrowseArtefactsRequestMessage req = new FragmentServiceStub.BrowseArtefactsRequestMessage();
			FragmentServiceStub.BrowseArtefactSelectorType type = new FragmentServiceStub.BrowseArtefactSelectorType();
	 ...
	 * @return
	 */
	public FragmentServiceStub.BrowseArtefactsResponseMessage browseArtifact_byDateType(
	 ...
	 * @return
	 */
	public FragmentServiceStub.RetrieveArtefactLatestVersionResponseMessage retrieveArtifactLatestVersion(
			long artifactId) {
		try {
	 ...
	 * @return
	 */
	public FragmentServiceStub.BrowseLocksResponseMessage browseLocks() {
		try {
	...
	/**
	 * TODO Still releases ALL locks instead of specific ones.
	 * 
	 * @param locks
	 * @return
	 */
	public FragmentServiceStub.ReleaseLocksResponseMessage releaseLocks(
	 ...
	 * @return
	 */
	public FragmentServiceStub.CreateRelationResponseMessage createRelation(
	 ...
	 * @return
	 */
	public FragmentServiceStub.RetrieveRelationResponseMessage retrieveRelation(
			long relationId) {
		try {
	 ...
	 * @return
	 */
	public FragmentServiceStub.BrowseRelationsResponseMessage browseRelation_byType(
			String relationType) {
		try {
	 ...
	 * @return
	 */
	public FragmentServiceStub.BrowseRelationsResponseMessage browseRelation_byDate(
			Calendar date_from, Calendar date_to) {
		try {
			FragmentServiceStub.BrowseRelationsRequestMessage req = new FragmentServiceStub.BrowseRelationsRequestMessage();
			FragmentServiceStub.RelationSelectorType type = new FragmentServiceStub.RelationSelectorType();
	 ...
	 * @return
	 */
	public FragmentServiceStub.BrowseRelationsResponseMessage browseRelation_bySourceId(
			long sourceId) {
		try {
			FragmentServiceStub.BrowseRelationsRequestMessage req = new FragmentServiceStub.BrowseRelationsRequestMessage();
			FragmentServiceStub.RelationSelectorType type = new FragmentServiceStub.RelationSelectorType();
	 ...
	 * @return
	 */
	public FragmentServiceStub.BrowseRelationsResponseMessage browseRelation_byTargetId(
			long targetId) {
		try {
			FragmentServiceStub.BrowseRelationsRequestMessage req = new FragmentServiceStub.BrowseRelationsRequestMessage();
			FragmentServiceStub.RelationSelectorType type = new FragmentServiceStub.RelationSelectorType();
	 ...
	 * @return
	 */
	public FragmentServiceStub.BrowseRelationsResponseMessage browseRelation_byDateType(
	 ...
	 * @return
	 */
	public FragmentServiceStub.UpdateRelationResponseMessage updateRelation(
	 ...
	 * @return
	 */
	public FragmentServiceStub.DeleteRelationResponseMessage deleteRelation(
			long relationId) {
		try {
